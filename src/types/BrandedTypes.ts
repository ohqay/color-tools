...
export namespace BrandedTypeGuards {
  ...
  export function isBrandedRGB(value: unknown): value is BrandedRGB {
    return (
      ...
      'g' in value &&
      'b' in value &&
      isRGBValue((value as any).r) &&
      isRGBValue((value as any).g) &&
      isRGBValue((value as any).b)
    );
  }
  ...
  export function isBrandedHSL(value: unknown): value is BrandedHSL {
    return (
      ...
      's' in value &&
      'l' in value &&
      isHueValue((value as any).h) &&
      isPercentValue((value as any).s) &&
      isPercentValue((value as any).l)
    );
  }
...
export namespace BrandedConverters {
  ...
  export function fromRegularRGB(rgb: { r: number; g: number; b: number }): BrandedRGB {
    return BrandedValidators.createBrandedRGB(rgb.r, rgb.g, rgb.b);
  }

  export function fromRegularRGBA(rgba: { r: number; g: number; b: number; a: number }): BrandedRGBA {
    return BrandedValidators.createBrandedRGBA(rgba.r, rgba.g, rgba.b, rgba.a);
  }

  export function fromRegularHSL(hsl: { h: number; s: number; l: number }): BrandedHSL {
    return BrandedValidators.createBrandedHSL(hsl.h, hsl.s, hsl.l);
  }

  export function fromRegularHSLA(hsla: { h: number; s: number; l: number; a: number }): BrandedHSLA {
    return BrandedValidators.createBrandedHSLA(hsla.h, hsla.s, hsla.l, hsla.a);
  }
